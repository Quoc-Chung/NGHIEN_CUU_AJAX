...
public partial class QlgiaiBongDaContext : DbContext
{
    ...
    public virtual DbSet<VwCauThuManchesterUnited> VwCauThuManchesterUniteds { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-LACSE5QS\\SQLEXPRESS;Initial Catalog=QLGiaiBongDa;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Caulacbo>(entity =>
        {
            entity.HasKey(e => e.CauLacBoId).HasName("PK__CAULACBO__144BAB432978451A");
            ...
            entity.Property(e => e.SoTranDau).HasDefaultValue(0);
        ...
        {
            entity.HasKey(e => e.HuanLuyenVienId).HasName("PK__HUANLUYE__8DF5FB219187928B");
        ...
        modelBuilder.Entity<Trandau>(entity =>
        {
            ...
            entity.ToTable("TRANDAU", tb => tb.HasTrigger("trg_UpdateSoTranDau"));
        ...
        {
            entity.HasKey(e => e.TrongTaiId).HasName("PK__TRONGTAI__94867D373FA1C658");
        ...
        modelBuilder.Entity<VwCauThuManchesterUnited>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_CauThuManchesterUnited");
            ...
            entity.Property(e => e.CauLacBoId)
                ...
                .HasColumnName("CauLacBoID");
            entity.Property(e => e.NgayThiDau).HasColumnType("datetime");
            entity.Property(e => e.TenCauThu).HasMaxLength(40);
            entity.Property(e => e.TenClb)
                .HasMaxLength(80)
                .HasColumnName("TenCLB");
            entity.Property(e => e.TenSan).HasMaxLength(60);
